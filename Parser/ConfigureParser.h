...
namespace CodeAnalysis
{
  ...
  private:
	...
	TypeDefinition* pTypedefdefination = nullptr;
	HandleTypeDefinition* pHandleTypedef = nullptr;

	AliasDefinition* pAliasDefination = nullptr;
	HandleAliasDefinition* pHandleAliasDefination = nullptr;
