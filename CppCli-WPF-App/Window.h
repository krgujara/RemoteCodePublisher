...
namespace CppCliWindows
{
	ref class WPFCppCliDemo : Window
	{
		...
		String^ msgText1
			= "Just Message Command:ShowMessage\n"   // command
		...
		String^ msgText = "Client Says Hello And Best of Luck For 4th Project";
		...
		Button^ hCheckinItemsButton = gcnew Button();
	...
	public:
		...
		void checkinItemsFromList(Object^ sender, RoutedEventArgs^ args);
